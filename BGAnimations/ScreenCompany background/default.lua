...
t[#t+1] = Def.Quad{
	OnCommand=function(self)
		self:xy(SCREEN_CENTER_X,SCREEN_CENTER_Y):stretchto(SCREEN_WIDTH*2,SCREEN_HEIGHT*2,0,0)
...
t[#t+1] = Def.Sprite{
	Texture="BGVid.mkv",
	OnCommand=function(self)
		self:xy(SCREEN_CENTER_X,SCREEN_CENTER_Y):zoom( 1.1*(SCREEN_WIDTH/640) )
...
t[#t+1] = Def.Sprite{
	...
	OnCommand=function(self)
		self:xy(SCREEN_CENTER_X,SCREEN_CENTER_Y):diffuse(color("0,0,0,1")):rotationz(-10)
